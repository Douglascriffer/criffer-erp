...
export default function MapaHeatBrasil({ stateData = [], darkMode = false, syncIndex = 0, isTVMode = false }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: isTVMode ? 380 : 300, display: 'flex', alignItems: 'center' }}>
      ...
      <div style={{ width: '100%', marginLeft: isTVMode ? '0' : '15%' }}>
        <ComposableMap
          ...
          projectionConfig={{ center: [-55, -18], scale: isTVMode ? 380 : 300 }}
          width={500} height={isTVMode ? 380 : 300}
