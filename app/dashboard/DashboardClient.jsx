...
export default function DashboardClient() {
  ...
  const totalEmpresa = filtered?.total || 0
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {activeSub === 'vendas' && (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  <div style={{ background: t.card, borderRadius: 6, border: `1.5px solid ${t.border}`, padding: 6, height: 325, display: 'flex', flexDirection: 'column' }}>
              ...
              {activeSub === 'metas' && (
               ...
               {/* Sub-aba: VENDEDORES */}
               {activeSub === 'rank' && (
                <div style={{ background: t.card, borderRadius: 6, border: `1.5px solid ${t.border}`, padding: 24, height: 749, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
