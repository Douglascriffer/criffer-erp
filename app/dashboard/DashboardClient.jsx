  ...
  return (
    <div style={{ 
      ...
      <main style={{ maxWidth: '100%', margin: '0 auto', padding: '0px 2% 0px 2%' }}>
        ...
        {/* ══ CARDS DE KPI (Top 7) - Ocultos no MAPA ══ */}
        {activeSub !== 'mapa' && (
              ...
              {activeSub === 'mapa' && (
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    <div style={{ background: t.card, borderRadius: 6, border: `1.5px solid ${t.border}`, padding: 16, minHeight: 420, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
