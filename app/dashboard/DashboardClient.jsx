  ...
  return (
    <div style={{ 
      ...
      <main style={{ maxWidth: '100%', margin: '0 auto', padding: '0px 2% 0px 2%' }}>
        ...
        {activeSub !== 'mapa' && activeSub !== 'rank' && activeSub !== 'metas' && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginBottom: 12, width: '100%', overflowX: 'auto', paddingBottom: 6 }}>
