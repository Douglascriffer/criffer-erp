...
const THEMES = {
  ...
  light: {
    bg: '#ffffff', // Máximo de branco possível
    card: '#ffffff',
    cardBorder: 'rgba(0,0,0,0.08)',
    cardHoverShadow: '0 40px 100px rgba(0,0,0,0.10), 0 10px 30px rgba(0,0,0,0.05)',
    ...
    gradientHovers: [
      ...
      'linear-gradient(180deg, rgba(34,197,94,0.02) 0%, #ffffff 50%, rgba(0,0,0,0.04) 100%)',
      'linear-gradient(180deg, rgba(59,130,246,0.02) 0%, #ffffff 50%, rgba(0,0,0,0.04) 100%)',
      'linear-gradient(180deg, rgba(239,68,68,0.02) 0%, #ffffff 50%, rgba(0,0,0,0.04) 100%)',
    ],
  },
}
